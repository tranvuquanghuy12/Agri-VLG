...
def parse_args():
    ...
    parser.add_argument('--retrieval_split', type=str, default='T2T_Filtered.txt', help='retrieval file name.')
    ...
    parser.add_argument('--use_gat', default=True, type=str2bool, help='Use Graph Attention Network.')
    ...
    parser.add_argument('--lr_gat', type=float, default=None, help='Learning rate for the GAT layers.')
    ...
    parser.add_argument('--dataset_path', type=str, default=None, help='Dataset path override.')
    parser.add_argument('--retrieved_path', type=str, default=None, help='Retrieved dataset path override.')
    ...
    with open('config.yml') as f:
        ...
        if args.retrieved_path is None:
    ...
    if args.data_source == 'fewshot':
        ...
        args.train_split = [[f'fewshot{args.shots}_seed{args.seed}.txt', args.retrieval_split],
                            [args.dataset_path, os.path.join(args.retrieved_path, args.dataset)]]
