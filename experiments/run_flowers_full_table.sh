#!/bash/bin
# Flowers102 Full Comparative Table (4, 8, 16 shots)
PYTHON="/opt/anaconda3/envs/swatai/bin/python"
DATASET="flowers102"
DATASET_ROOT="/home/dat_tlu/TVQH_TLU-SWAT_GAT/Dataset"
PREFIX="Final_T0.85_K5"
OUTPUT_ROOT="output/FLOWERS_FULL_TABLE"
...
for SHOT in "${SHOTS[@]}"; do
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "🚀 ĐANG XỬ LÝ FLOWERS102 - MỐC $SHOT SHOTS"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

    # 1. FT-Fewshot (Chỉ dùng data few-shot)
...
echo "🎉 HOÀN THÀNH TỔNG BIỂU FLOWERS102!"
