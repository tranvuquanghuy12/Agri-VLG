...
OUTPUT_ROOT=output/GRID_SEMIAVES_16SHOT
...
echo "🚀 BẮT ĐẦU CHẠY GRID SEARCH 16-SHOT CHO SEMI-AVES..."
echo "🔥 CẤU HÌNH: prompt_name=most_common_name | Shots: 16"

for T in "${TAUS[@]}"; do
    for K in "${KS[@]}"; do
        CASE_NAME="Grid_T${T}_K${K}"
        echo "----------------------------------------------------"
        echo "🔹 Đang xử lý: Tau=$T, K=$K (16-shot)"
        ...
        # 2. Chạy Training Full các Stage (16 SHOTS)
        echo "   -> Đang huấn luyện (Training 16-shot)..."
        $PYTHON main.py --dataset $DATASET --dataset_path $DATASET_ROOT \
            ...
            --shots 16 --epochs 20 --prompt_name most_common_name --recal_prompt \
            --log_mode file
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🎉 TẤT CẢ ĐÃ XONG! Sếp dùng lệnh sau để xem bảng tổng hợp 16-shot:"
